package yc.ycqin.doth.client.render.shader;
...
public final class ShaderHelper {
    ...
    private static final String PREFIX = "/assets/bluecreepersword/shader/";
    ...
    public static void useShader(int shader, ShaderCallback callback) {
        ...
        if (shader != 0) {
            ...
            if (mc.player != null && mc.player.world != null) {
                // 改成 % 24000，让时间永远在 0 ~ 23999 之间循环
                ARBShaderObjects.glUniform1iARB(time, (int) (mc.player.world.getWorldTime() % 24000));
            }
